...
use crate::transport::{
    FLOW_SOURCE_RELAY_A, SocketPairConfig, emit_packets, now_ns, seconds_from_ns,
};

pub(crate) struct TreeSourceEndpoint {
...
impl TreeSourceEndpoint {
    ...
    pub(crate) const MAILBOX: &'static str = "tree_source";
    pub(crate) const SEND_OWNER: &'static str = "source.sndbuf";
    ...
    fn update_ownership(&self) {
        self.ownership
            .set(Self::SEND_OWNER, self.sender.send_buffered_bytes());
    }
...
impl Model for TreeSourceEndpoint {
    type Env = ();

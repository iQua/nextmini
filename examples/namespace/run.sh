...
signal_file="/tmp/nextmini-start-signal-$$"
...
# Memory monitoring command (uses separate script for cleaner output)
monitor_cmd="${script_dir}/monitor-memory.sh ${nodes_for_report} \"${signal_file}\" \"${memory_report}\""

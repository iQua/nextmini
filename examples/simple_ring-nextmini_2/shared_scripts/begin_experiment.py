...
def main():
    ...
    parser.add_argument("-m", "--method", choices=["dynamicAlloc", "weightAlloc", "multiRing", "dataAwareAlloc", "multiRingWeight", "dataAware", "equalAlloc", "equalOutOfOrderAlloc", "equalPerLink"], default="dynamicAlloc", help="Choose an algorithm to use")

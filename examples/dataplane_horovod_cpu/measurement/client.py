...
def send_data(socket):
    ...
    payload_size = 1024  # Size of the payload (1kB in this example)
...
def main():
   ...
   # controller_address = ('10.0.0.6', 10234)  # Controller IP address and port
    controller_address = (SERVER_ADDR , SERVER_PORT)  # Controller IP address and port
